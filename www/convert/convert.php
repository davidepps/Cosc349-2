...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Pacific/Niue'");
echo "The date and time in Niue is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
  echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Niue is -24 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Pacific/Honolulu'");
echo "The date and time in Honolulu Hawaii USA is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
  echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Honolulu is -23 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Pacific/Gambier'");
echo "The date and time in Gambier Islands is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
  echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Gambier is -22 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Pacific/Pitcairn'");
echo "The date and time in Pitcairn Islands is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
 echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Pitcairn is -21 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='America/Phoenix'");
echo "The date and time in Phoenix Arizona USA is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
  echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Phoenix is -20 hours";
}
break;
...
$dt->setTimezone($time);
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Chile/EasterIsland'");
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='America/Chicago'");
echo "The date and time in Chicago Illinois USA is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Chicago is -18 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='America/New_York'");
echo "The date and time in New York City New York USA is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and New York is -17 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='America/Argentina/Buenos_Aires'");
echo "The date and time in Buenos Aires Argentina is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Buenos Aires is -16 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Atlantic/South_Georgia'");
echo "The date and time in South Georgia is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and South Georgia is -15 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Atlantic/Cape_Verde'");
echo "The date and time in Cape Verde is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Cape Verde a is -14 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Iceland'");
echo "The date and time in Iceland is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Iceland a is -13 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Africa/Kinshasa'");
echo "The date and time in Kinshasa Democratic Republic of Congo is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Kinshasa a is -12 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Africa/Johannesburg'");
echo "The date and time in Johannesburg South Africa is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
 echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Johannesburg a is -11 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Asia/Baghdad'");
echo "The date and time in Baghdad Iraq is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Baghdad is -10 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Asia/Dubai'");
echo "The date and time in Dubai United Arab Emirates is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
 echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Dubai is -9 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Indian/Maldives'");
echo "The date and time in Maldives is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
 echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Maldives is -8 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Asia/Omsk'");
echo "The date and time in Omsk Russia is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Omsk is -7 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Asia/Krasnoyarsk'");
echo "The date and time in Krasnoyarsk Russia is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
 echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Krasnoyarsk is -6 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Australia/Perth'");
echo "The date and time in Perth Australia is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Perth is -5 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Asia/Tokyo'");
echo "The date and time in Tokyo Japan is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Tokyo is -4 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Pacific/Guam'");
echo "The date and time in Guam is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
 echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Guam is -3 hours";
}
break;
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Pacific/Noumea'");
echo "The date and time in Noumea New Caledonia is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
 echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Noumea is -2 hours";
}
break;
...
$auckland_time = new DateTimeZone('Pacific/Auckland');
$dt->setTimezone($auckland_time);
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Pacific/Auckland'");
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Pacific/Apia'");
...
$q = $pdo->query("SELECT offset FROM asgn2db.timezones WHERE name='Pacific/Kiritimati'");
echo "The date and time in Kiritimati Republic of Kiribati is: " . $dt->format('d-m-Y H:i:s A');
echo "<br>";
while($row = $q->fetch()){
echo "The offset from GMT is " . "<tr><td>".$row["offset"]."</td></tr>\n";
echo "<br>";
echo "The difference between local time and Kiritimati is +1 hours";
}
break;
